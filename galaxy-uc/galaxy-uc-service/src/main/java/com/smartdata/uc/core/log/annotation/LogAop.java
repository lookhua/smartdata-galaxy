package com.smartdata.uc.core.log.annotation;
...
import com.smartdata.uc.core.log.action.model.ActionModel;
import com.smartdata.uc.core.log.action.model.BusinessMethod;
import com.smartdata.uc.core.log.action.model.BusinessType;
import com.smartdata.uc.system.domain.ActionLog;
import com.smartdata.uc.system.service.ActionLogService;
...
public class LogAop {
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        com.smartdata.uc.core.log.annotation.ActionLog anno =
                targetMethod.getAnnotation(com.smartdata.uc.core.log.annotation.ActionLog.class);
        // 获取name值
